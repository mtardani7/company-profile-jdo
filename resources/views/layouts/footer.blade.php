    ...
    <div class="container text-start" style="margin-top: 20px;"> 
      <div class="row align-items-center">
        ...
        <div class="sosmed col">
          <div class="container text-start mb-4" style="font-size: 30px;">
            <div class="row">
              <div class="col">
          ...
          <div class="container text-start" style="margin-top: 20px;">
            <div class="contact-info">
              ...
              <p><i class="bi bi-geo-alt-fill" style="margin-bottom: 70px"></i> Jl. Berbek Industri V No.21, Bebek, Berbek, Kec. Waru, Kabupaten Sidoarjo, Jawa Timur 61256</p>
            </div>
          </div>
        </div>
      </div>
